...
### RadSEC RFC 6614
Эволюция безопасности и уход от UDP. RADIUS over TLS / DTLS (RFC 6614). Суть: Завернуть весь RADIUS-трафик в безопасный туннель (TLS по TCP или DTLS по UDP). При этом сохраняется поддержка EAP
